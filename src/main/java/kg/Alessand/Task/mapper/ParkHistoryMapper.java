...
public interface ParkHistoryMapper {
    ...
    ParkHistory toParkHistory(ParkDto parkDto);

    ParkHistoryDto toParkHistoryDto(Park park);

    List<ParkHistory> toParkHistoryList(List<ParkHistoryDto> ParkHistoryDtoList);

    List<ParkHistoryDto> toParkHistoryDtoList(List<ParkHistory> parkHistoryList);
}
